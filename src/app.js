...
function render(){
 ...
 app.innerHTML=view(s);if(field){const input=app.querySelector(`[data-field="${field}"]`);input?.focus({preventScroll:true});if(pos&&typeof pos[0]==='number')input?.setSelectionRange(...pos);}
